// You're modelling the interaction between a large number of quarks and have 
// decided to create a Quark class so you can generate your own quark objects.
...
// "blue", and "green") and any valid flavor ('up', 'down', 'strange', 'charm', 
// 'top', and 'bottom').

// Every quark has the same baryon_number (BaryonNumber in C#): 1/3.

// Every quark should have an .interact() (.Interact() in C#) method that allows 
// any quark to interact with another quark via the strong force. When two quarks 
